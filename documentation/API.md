...
```mermaid
graph TD
    A[Student Mobile Frontend - Vercel] -->|HTTPS / REST API| C[Render Backend - Flask/Gunicorn]
    B[Admin Web Frontend - Vercel] -->|HTTPS / REST API| C
    C -->|MySQL over SSL| D[(Aiven MySQL Database)]
 ```
...
* **CORS Management:** Flask-CORS 6.0.5
* **Database Driver:** PyMySQL 1.2.0
* **WSGI Server:** Gunicorn (Production)
* **Database Engine:** MySQL Community 8.0.46 (Local) / Aiven MySQL 8.4.8 (Production)
